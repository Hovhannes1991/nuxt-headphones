<template>
  <div class="latest_collection">
    <h2 class="section_title">Our Latest Collention</h2>

    <div v-if="images.length" class="slider flex-center">
      <div class="previous_image">
        <img
          @click="changeSlide(current_slide - 1)"
      ...
      <div class="slider_content">
        <div class="left_image flex-center" key="111">
          <img
            v-if="current_slide > 0"
            :src="'images/' + images[current_slide - 1]"
            alt="previous image"
            key="1"
          />
          <img
        ...
        <div class="center_image flex-center" key="222">
          <img
            :src="'images/' + images[current_slide]"
            alt="current image"
            key="3"
          />
        </div>
        ...
        <div class="right_image flex-center" key="333">
          <img
            v-if="current_slide < images.length - 1"
            :src="'images/' + images[current_slide + 1]"
            alt="next image"
            key="4"
          />
